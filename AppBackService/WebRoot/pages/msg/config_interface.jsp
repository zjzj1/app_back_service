...
<head>
	...
	<script type="text/javascript">
		var cxt = "<%=basePath%>" ;
		var baseUrl = cxt+"/configInterface.do";
				...
				>
					<thead>
						<tr>
							...
							<th data-field="intfHandler">任务处理类</th>
							<th data-field="receiveDeal">接收处理类</th>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="form">
			  ...
			  <div class="form-group">
			    <label>任务处理类</label>
			    <input id="intfHandler" type="text" class="form-control" >
			  </div>
			  <div class="form-group">
			    <label>接收处理类</label>
			    <input id="receiveDeal" type="text" class="form-control" >
			  </div>
