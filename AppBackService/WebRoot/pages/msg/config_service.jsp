...
<head>
	...
	<script type="text/javascript">
		var cxt = "<%=basePath%>" ;
		var baseUrl = cxt+"/configService.do";
		...
		<div class="row-fluid">
			...
			<div class="span12">
				...
				<table class="table table-striped" id="table" data-toggle="table" data-click-to-select="true" 
					data-show-toggle="true" data-search="true" data-id-field="intfCode"
				>
					<thead>
						<tr>
							<th data-radio="true"></th>
							<th data-field="intfCode">接口编码</th>
							<th data-field="intfName">服务名称</th>
							<th data-field="clientCode">客户端编码</th>
							<th data-field="servCode">服务端编码</th>
							<th data-field="operCode">操作编码</th>
							<th data-field="servAddress">服务端地址</th>
							<th data-field="servPort">服务端端口</th>
							<th data-field="intfTmpl" data-visible="false">内容模板</th>
						</tr>
					</thead>
				</table>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="form">
			  ...
			  <div class="form-group">
			    <label>服务名称</label>
			    <input id="intfName" type="text" class="form-control" >
			  </div>
			  <div class="form-group">
			    <label>客户端编码</label>
			    <input id="clientCode" type="text" class="form-control" >
			  </div>
			  <div class="form-group">
			    <label>服务端编码</label>
			    <input id="servCode" type="text" class="form-control" >
			  </div>
			  <div class="form-group">
			    <label>操作编码</label>
			    <input id="operCode" type="text" class="form-control" >
			  </div>
			  <div class="form-group">
			    <label>服务端地址</label>
			    <input id="servAddress" type="text" class="form-control" />
			  </div>
			  <div class="form-group">
			    <label>服务端端口</label>
			    <input id="servPort" type="text" class="form-control" />
			  </div>
			  <div class="form-group">
			    <label>内容模板</label>
			    <textarea id="intfTmpl" type="text" class="form-control" style="height:200px" ></textarea>
			  </div>
			</form>
	      </div>
