...
<head>
	...
	<script type="text/javascript">
		var cxt = "<%=basePath%>" ;
		var baseUrl = cxt+"/quartzTrigger.do";
		...
		<div class="row-fluid">
			...
			<div class="span12">
				...
				<table class="table table-striped" id="table" data-toggle="table" data-click-to-select="true" 
					data-show-toggle="true" data-search="true" data-id-field="triCode"
				>
					<thead>
						<tr>
							<th data-radio="true"></th>
							<th data-field="triGroCode">触发器组编码</th>
							<th data-field="triCode">触发器编码</th>
							<th data-field="triName">触发器名称</th>
							<th data-field="triCron">触发器CRON</th>
						</tr>
					</thead>
				</table>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="form">
			  ...
			  <div class="form-group">
			    <label>触发器名称</label>
			    <input id="triName" type="text" class="form-control" >
			  </div>
			  <div class="form-group">
			    <label>触发器CRON</label>
			    <input id="triCron" type="text" class="form-control" >
			  </div>
